    ...
    public class PrivateN
    {
                    ...
                    if (id == 2)
                    {
                        ...
                        if (semi == 0)
                        {
                            ...
                            if (variables.cpkey != "")
                            {
                                ...
                                Console.Write("uf.ldv_cb = " + uf.ldv_cb + "\n");
                                ...
                                Console.Write("uf.pd_cb = " + uf.pd_cb + "\n");
                       ...
                       // if (variables.debugme) Console.WriteLine("-Found {0}BL Patch {3} (build {1}) at {2:X}", id, block_build, block_offset_b, patch);
                        if (id == 6)
                        {
                            ...
                            if (patch == 0)
                            {
                                ...
                                Console.Write("uf.ldv_p0 = " + uf.ldv_p0 + "\n");
                            ...
                            else
                            {
                                ...
                                Console.Write("uf.ldv_p1 = " + uf.ldv_p1 + "\n");
        ...
        public void getbadblocks()
        {
            ...
            for (counter = 0; counter < image.Length / blocksize; counter++)
            {
                ...
                if (BadBlock.checkifbadblock(block, counter, bigblock, true))
                {
    ...
    public static class Nand
    {
       ...
       /* public static long kvcrc(string filename)
        ...
        public static string getConsoleName(PrivateN nand, string flashconfig = "")
        {
            ...
            if (cons[2] == cons[9] && consl == 2) return "Falcon/Opus";
        ...
        {
            //new consoles(-1, "", "", "", -1, Nandsize.S0),
            //new consoles(1, "trinity", "trinity", "Trinity", 16, Nandsize.S16), 
            //new consoles(2, "falcon", "falcon", "Falcon", 16, Nandsize.S16),
            //new consoles(3, "zephyr", "zephyr", "Zephyr", 16, Nandsize.S16), 
            //new consoles(4, "jasper", "jasper", "Jasper 16MB", 16, Nandsize.S16), 
            //new consoles(5, "jaspersb", "jasper", "Jasper SB", 16, Nandsize.S16), 
            //new consoles(6, "jasper256", "jasper", "Jasper 256MB", 256, Nandsize.S256), 
            //new consoles(7, "jasper512", "jasper", "Jasper 512MB", 512, Nandsize.S512), 
            //new consoles(8, "xenon", "xenon", "Xenon", 16, Nandsize.S16), 
            //new consoles(9, "falcon", "falcon", "Opus", 16, Nandsize.S16), 
            //new consoles(10, "corona", "corona", "Corona", 16, Nandsize.S16), 
            //new consoles(11, "corona4g", "corona", "Corona 4GB", 0, Nandsize.S0), 
            ...
            //flashconfig check
            if (!string.IsNullOrEmpty(flashconfig))
            {
        ...
        public static void decrypt_fcrt(byte[] fcrt, byte[] cpukey)
        {
            ...
            try
            {
                ...
                if (cpukey.Length != 0x10) { Console.WriteLine("Wrong cpukey size"); return; }
